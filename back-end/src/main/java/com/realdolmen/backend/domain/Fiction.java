...
public class Fiction extends Book {
    ...
    @Builder
    public Fiction(Long id, Long version, String title, Double price, String type, String author, String isbn, String pages, FictionGenre fictionGenre, String summary) {
